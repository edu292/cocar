            ...
            <div class="p-8">
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-cocar-blue/10 mb-4 relative">
                        <img src="{{ asset('favicons/favicon.svg') }}" alt="Ícone Novo Membro">
                    </div>
                    <h1 class="text-3xl font-bold text-cocar-blue tracking-tight">Junte-se à <span class="text-cocar-orange">Tribo</span></h1>
                    <p class="text-sm text-cocar-green font-medium mt-1">Crie sua conta no CoCar</p>
                </div>
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        <label for="role" class="block text-sm font-medium text-gray-700 mb-1">Como você vai usar o CoCar?</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <select id="role" name="role" required
                                ...
                                <option value="passageiro" {{ old('role') == 'passageiro' ? 'selected' : '' }}>Quero pegar carona (Passageiro)</option>
                                <option value="motorista" {{ old('role') == 'motorista' ? 'selected' : '' }}>Vou oferecer carona (Motorista)</option>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('login') }}" class="font-bold text-cocar-blue hover:text-blue-800 transition-colors duration-200">
                            Faça login
                        </a>
                    </p>
                </div>
