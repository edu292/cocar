...
=======
                    ...
                    <h1 class="sidebar__heading text-green">
                ...
                <ul class="sidebar__list">
                    <li class="sidebar__list-item">
                        <a href="" class="sidebar__link">
                            ...
                            <span class="sidebar-link__text">Aprovações Pendentes</span>
                        </a>
                    </li>
                    <li class="sidebar__list-item">
                        <a href="" class="sidebar__link">
                            ...
                            <span class="sidebar-link__text">Meus usuários</span>
                        </a>
                    </li>
                    <form action="{{ route('logout') }}"method="post"
                        class="sidebar-list__item sidebar-list__item--logout">
